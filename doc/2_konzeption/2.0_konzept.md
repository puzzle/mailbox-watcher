...
Der Benutzer kann sich via Token authentifizieren. Dieses Token ist einmalig und als environment Variable hinterlegt.
...
Die Informationen, um sich mit einem Mailserver verbinden zu können, werden aus dem Secret File ausgelesen. Das Secret File ist ein YAML-File.
...
**Simples UI mit Haml, CSS & Javascript**
